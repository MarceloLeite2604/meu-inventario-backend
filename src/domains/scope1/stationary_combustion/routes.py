...
@router.get("", response_model=list[EmissaoEstacionariaResponse])
...
@router.post("", response_model=EmissaoEstacionariaResponse, status_code=201)
...
@router.get("/{record_id}", response_model=EmissaoEstacionariaResponse)
