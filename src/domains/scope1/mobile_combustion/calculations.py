...
def calculate(
    ...
    co2 = quantidade_fossil * factors.fator_co2
    ch4 = quantidade_fossil * factors.fator_ch4
    n2o = quantidade_fossil * factors.fator_n2o

    co2_bio = quantidade_biocombustivel * factors.fator_co2_bio
    ch4_bio = quantidade_biocombustivel * factors.fator_ch4_bio
    n2o_bio = quantidade_biocombustivel * factors.fator_n2o_bio

    total_tco2e = co2 + (ch4 * gwp_ch4 / 1000) + (n2o * gwp_n2o / 1000)

    return MobileCombustionResult(
        emissoes_co2=co2,
        emissoes_ch4=ch4,
        emissoes_n2o=n2o,
