...
@router.get("", response_model=list[EmissaoEfluenteResponse])
...
@router.post("", response_model=EmissaoEfluenteResponse, status_code=201)
...
@router.get("/{record_id}", response_model=EmissaoEfluenteResponse)
